...
def get_params():
    ...
    parser.add_argument('--method',             default='deep_expert',     type=str, choices=METHODS.keys())

    parser.add_argument('--seed',               default=0,          type=int)
    parser.add_argument('--run_nums',           default=15,         type=int)
    ...
    # my params
    parser.add_argument('--dummy_cls',          default=0,          type=int)
    parser.add_argument('--use_dummy_cls',      default='off',       type=str, choices=['off', 'on'])
    parser.add_argument('--reinit_optimizer',   default='on',       type=str, choices=['off', 'on'])
    parser.add_argument('--fc_bias',            default=False,       type=bool)
    parser.add_argument('--nums_expert',        default=4,          type=int)
    parser.add_argument('--proj_dim', default=[128, 128, 128, 128], type=list)
    parser.add_argument('--mse_weight',         default=10.,        type=float)
    parser.add_argument('--dist_weight',        default=2., type=float)
    parser.add_argument('--temp',               default=2.,        type=float)
    parser.add_argument('--compensate',         default='on',      type=str, choices=['off', 'on'])
    parser.add_argument('--sigma',              default=0.3,        type=float)
    parser.add_argument('--sdl_weight',         default=1.0, type=float)
    ...
    # logging 
    parser.add_argument('--exp_name',           default='compensate',      type=str)
